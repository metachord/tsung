...
utils_md5_test()->
    ...
    ?assertMatch(Bin,  ts_pgsql_proto:encode_message(pass_md5, {User,Password,Salt} ) ).
...
encode_parse_test()->
    ...
    Rep=ts_pgsql_proto:encode_message(parse,{Prep,Query,[1042]}),
    ?assertEqual(Res,Rep).

encode_parse2_test()->
    Rep=ts_pgsql_proto:encode_message(parse,{<< >>,<< >>,[]}),
