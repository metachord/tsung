...
%% Purpose: encoder and decoder to the types in mod ts_ELDAPv3
...
%%-------------------------------------------------
%% attribute number 3   External ts_ELDAPv3:Controls OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External ts_ELDAPv3:Referral OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External ts_ELDAPv3:AuthenticationChoice
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 7   External ts_ELDAPv3:Filter
%%-------------------------------------------------
   {EncBytes7,EncLen7} = 'enc_Filter'(?RT_BER:cindex(8,Val,filter), []),

%%-------------------------------------------------
%% attribute number 8   External ts_ELDAPv3:AttributeDescriptionList
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External ts_ELDAPv3:PartialAttributeList
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External ts_ELDAPv3:AttributeTypeAndValues
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External ts_ELDAPv3:AttributeList
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External ts_ELDAPv3:AttributeValueAssertion
%%-------------------------------------------------
